        ...
        YTPlayer = {
            ...
            init: function(o, n) {
                ...
                return i.userOptions = n, i.$body = e("body"), i.$node = e(o), i.$window = e(t), i.defaults.events = {
                    onReady: function(e) {
                        i.onPlayerReady(e), "function" == typeof i.options.callback && i.options.callback.call(this)
                    },
            ...
            destroy: function() {
                var o = this;
                o.$node.removeData("yt-init").removeData("ytPlayer").removeClass("loaded"), o.$YTPlayerString.remove(), e(t).off("resize.YTplayer" + o.ID), o.$body = null, o.$node = null, o.$YTPlayerString = null, o.player.destroy(), o.player = null
            }
        ...
        $(this).each(function() {
            ...
            if (select.prev('span.selectbox').length < 1) {
                function doSelect() {
                    ...
                    var selectbox = $('<span class="selectbox" style="display:inline-block;position:relative">' + '<div class="select" style="float:left;position:relative;z-index:10"><div class="text">' + optionText + '</div>' + '<b class="trigger"><i class="arrow"></i></b>' + '</div>' + '<div class="dropdown" style="position:absolute;z-index9;overflow:auto;overflow-x:hidden;list-style:none">' + '<ul>' + ddlist + '</ul>' + '</div>' + '</span>');
...
(function(c) {
    jQuery.fn.lavaLamp = function(a) {
        ...
        return this.each(function() {
            function m(e, c) {
                "return" == c ? a.returnStart(e) : a.hoverStart(e);
                e || (e = b);
                a.includeMargins || (h = d(e.css("marginLeft")), k = d(e.css("marginTop")));
                var g = {
                    left: e.position().left + h,
                    top: e.position().top + k,
                    width: e.outerWidth() - n,
                    height: e.outerHeight() - p
                };
                f.stop().animate(g, a.speed, a.fx, function() {
                    "return" == c ? a.returnFinish(e) : a.hoverFinish(e)
                })
            }
            "static" ==
            c(this).css("position") && c(this).css("position", "relative");
            if (a.homeTop || a.homeLeft) {
                var q = c("<" + a.container + ' class="' + a.homeClass + '"></' + a.container + ">").css({
                    left: a.homeLeft,
                    top: a.homeTop,
                    width: a.homeWidth,
                    height: a.homeHeight,
            ...
            var w = location.pathname + location.search + location.hash,
                l = c(a.target, this).not("." + a.skipClass),
                g, n = 0,
                p = 0,
                t = 0,
                u = 0,
                h = 0,
                k = 0;
            var b = c(a.target + "." + a.selectClass, this);
            "" != a.startItem && (b = l.eq(a.startItem));
            (a.homeTop || a.homeLeft) &&
            1 > b.length && (b = q);
            if (1 > b.length) {
                var r = 0,
                    v;
                l.each(function() {
                    var a = c("a:first", this).attr("href"); - 1 < w.indexOf(a) && a.length > r && (v = c(this), r = a.length)
                });
                0 < r && (b = v)
            }
            1 > b.length && (b = l.eq(0));
            ...
            l.on("mouseenter focusin", function() {
                ...
                a.setOnClick && (b.removeClass(a.selectClass), b = c(this).addClass(a.selectClass));
                return a.click.apply(this, [e, this])
            });
            var f = c("<" + a.container + ' class="backLava"><div class="leftLava"></div><div class="bottomLava"></div><div class="cornerLava"></div></' +
                a.container + ">").css({
                position: "absolute",
                display: "block",
                margin: 0,
            ...
            a.includeMargins && (t = d(b.css("marginTop")) + d(b.css("marginBottom")), u = d(b.css("marginLeft")) + d(b.css("marginRight")));
            n = d(f.css("borderLeftWidth")) + d(f.css("borderRightWidth")) + d(f.css("paddingLeft")) + d(f.css("paddingRight")) - u;
            p = d(f.css("borderTopWidth")) + d(f.css("borderBottomWidth")) + d(f.css("paddingTop")) + d(f.css("paddingBottom")) - t;
            a.homeTop || a.homeLeft ? f.css({
                left: a.homeLeft,
                top: a.homeTop,
                width: a.homeWidth,
                height: a.homeHeight
            }) : (a.includeMargins || (h = d(b.css("marginLeft")), k = d(b.css("marginTop"))), f.css({
                left: b.position().left + h,
                top: b.position().top + k,
                width: b.outerWidth() - n,
                height: b.outerHeight() - p
            }));
            c(this).on("mouseleave focusout", function() {
                var b = null;
                if (a.returnHome) b = q;
                else if (!a.autoReturn) return !0;
                a.returnDelay ? (g && clearTimeout(g), g = setTimeout(function() {
                    m(b, "return")
                }, a.returnDelay)) : m(b, "return");
                return !0
            })
        })
    }
